...
myFont :: String
myFont = "xft:Mononoki Nerd Font Mono:regular:size=12:antialias=true:hinting=true"
...
myStartupHook = do
    ...
    spawnOnce "feh --bg-fill /usr/share/backgrounds/arcolinux/arco-wallpaper.jpg &"
...
myShowWNameTheme = def
    { swn_font              = "xft:Ubuntu Nerd Font:bold:size=30"
    , swn_fade              = 1.0
    , swn_bgcolor           = "#045959"
    , swn_color             = "#ffffff"
    }
...
myWorkspaces    = [" \62057 "," \59285 "," \61729 "," \63890 "," \61564 "," \61501 "," \61705 "," \63464 "," \63591 "]
...
myKeys =
    ...
    --     , ("M-S-<Return>", spawn "dmenu_run -i -p \"Run: \"") -- Dmenu
        , ("M-S-<Return>", spawn "~/.config/rofi/bin/launcher_misc") -- Dmenu
...
main = do
    ...
    xmonad $ ewmh def
        ...
        , logHook = dynamicLogWithPP $ namedScratchpadFilterOutWorkspacePP $ xmobarPP
              ...
              , ppCurrent = xmobarColor "#c792ea" "" . wrap "<box type=Bottom offset=R4 width=2 mb=2 color=#c792ea> "  " </box>"         -- Current workspace
              , ppVisible = xmobarColor "#c792ea" "" . clickable              -- Visible but not current workspace
              , ppHidden = xmobarColor "#82AAFF" "" . wrap "<box type=Top offset=R4 width=2  mt=1 color=#82AAFF> "   " </box>" . clickable -- Hidden workspaces
              , ppHiddenNoWindows = xmobarColor "white" ""  . clickable     -- Hidden workspaces (no windows)
